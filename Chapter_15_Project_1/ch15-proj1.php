              ...
              <div class="mdl-cell mdl-cell--12-col mdl-card  mdl-shadow--2dp">
                ...
                <div class="mdl-card__supporting-text">
                    ...
                    if(isset($_COOKIE['THEME'])) {
                        ...
                        echo "<p>To test this persistent cookie, close browser and then reopen this page</p>";
                    } else {
                    ...
                    if(isset($_SESSION['PHILOSOPHER'])) {
                        echo "<p>The session PHILOSOPHER cookie value is: " . $_SESSION['PHILOSOPHER'] . "</p>";
                        echo "<p>To test this session cookie, click link below to go to another page in same domain</p>";
                    } elseif(isset($_COOKIE['PHILOSOPHER'])) {
